...
import {
  loadRoutingProvenanceScenario,
  loadSourceShardProvenanceScenario,
  validateCoreFixtureCase
} from "../lib/core-fixture-validator.mjs";
import {
...
const validateCase = validateCoreFixtureCase;
