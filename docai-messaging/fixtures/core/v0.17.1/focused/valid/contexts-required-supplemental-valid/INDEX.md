...
|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order command | workflows/a-required.md, workflows/none.md | references/guide.md, workflows/z-supplemental.md |

## Workflows

| Name | Summary | Details |
|---|---|---|
| A required | Required order sequence | workflows/a-required.md |
| None named | Unambiguous none path | workflows/none.md |
| Z supplemental | Optional order sequence | workflows/z-supplemental.md |
