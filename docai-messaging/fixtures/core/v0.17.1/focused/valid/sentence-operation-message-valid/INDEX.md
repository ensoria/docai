...
### channels/sentences.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | sentences.alpha | publish-alpha | alpha-created; alpha-updated | publish alpha event | Publishes an alpha event selected by its observable condition | none | none |
| SEND | sentences.beta | publish-beta | beta-created; beta-updated | publish beta event | Publishes a beta event selected by its observable condition | none | none |
