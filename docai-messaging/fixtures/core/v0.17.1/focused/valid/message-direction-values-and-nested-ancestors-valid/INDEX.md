...
|---|---|---|---|---|---|---|---|
| RECEIVE | orders.events | receive-order | order-received | receive order | Observes optional, conditional, and unknown message facts | none | none |
| SEND | orders.commands | send-order | order-command | send order | Constructs conditionally required nested order data | none | none |
