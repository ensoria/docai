...
|---|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order using a formatted workflow identifier | workflows/formatted.md | none | Data Representation |

## Workflows

| Name | Summary | Details |
|---|---|---|
| Formatted | Required formatted identifier sequence | workflows/formatted.md |
