...
### channels/failure-root.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | failures.root | publish-with-failure-root | publish-message | publish a failure-prone message | Publishes a message with a stable root-row failure signal | none | none |
