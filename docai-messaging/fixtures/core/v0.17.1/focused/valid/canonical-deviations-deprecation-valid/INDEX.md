...
### channels/deviations.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | bindings.commands.{tenant} | publish-order | publish-order; reply:publish-order-reply | publish order | (deprecated) Publishes an order with explicit convention deviations and correlated reply handling | none | none |
