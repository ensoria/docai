...
### channels/media-identities.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | media.identities | emit-media-identities | identity-message | inspect emitted media identities | Uses post-adapter media types consistently across representation identities | none | none |
