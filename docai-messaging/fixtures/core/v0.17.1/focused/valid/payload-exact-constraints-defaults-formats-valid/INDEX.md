...
### channels/constraints.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | constraints.commands | exact-constraints | exact-message | validate exact constraints | Preserves exact constraints, defaults, and format semantics | none | none |
| RECEIVE | constraints.events | receive-default | receive-default-message | consume defaulted value | Treats an absent optional field as its effective default | none | none |
