...
### channels/bindings.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | bindings.commands | publish-order | publish-order; reply:publish-order-reply | publish order | Uses scoped Kafka bindings for publishing and its reply and failure signals | none | none |
