...
### channels/incomplete-deviations.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | deviations.incomplete.{tenant} | publish-with-incomplete-deviations | incomplete-command; reply:incomplete-reply | publish incomplete deviation case | Publishes a command while retaining independently known deviations beside incomplete states | none | none |
