...
### channels/mixed-markers.md

| Action | Channel | Operation | Message | Task | Summary | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | orders.{tenant} | mixed-markers | mixed-marker-message; reply:mixed-marker-reply | publish mixed markers | Exercises deterministic post-table marker ordering across every Core table surface | none | none |
