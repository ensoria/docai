...
| Action | Channel | Operation | Message | Task | Description | Required context | Supplemental context |
|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order command | none | none |
