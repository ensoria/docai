...
|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order command | workflows/z.md, workflows/a.md | none |
...
| Z workflow | Last order sequence | workflows/z.md |
