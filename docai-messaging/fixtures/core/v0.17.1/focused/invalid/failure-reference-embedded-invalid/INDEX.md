...
|---|---|---|---|---|---|---|---|
| SEND | failures.reference | embedded-reference | embedded-reference-message | publish embedded failure reference | Publishes with a noncanonical embedded shape reference | none | none |
