...
|---|---|---|---|---|---|---|---|
| SEND | wire.parameterized | parameterized-as-raw | parameterized-as-raw-message | validate raw boundary | Incorrectly presents parameterized JSON as opaque raw bytes | none | none |
