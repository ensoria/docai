...
|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order command | workflows/a.md, workflows/a.md | none |

## Workflows

| Name | Summary | Details |
|---|---|---|
| A workflow | Order sequence | workflows/a.md |
