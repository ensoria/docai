...
|---|---|---|---|---|---|---|---|
| SEND | behavior.commands | missing-unknown-marker | missing-unknown-marker | send with unknown delivery | Omits the required post-key missing-fact marker | none | none |
