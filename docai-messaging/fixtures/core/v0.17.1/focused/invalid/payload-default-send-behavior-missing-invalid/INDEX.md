...
|---|---|---|---|---|---|---|---|
| SEND | defaults.missing | missing-default-behavior | missing-default-message | validate default and constraint semantics | Omits the required SEND construction behavior for a behavioral default. | none | none |
