...
|---|---|---|---|---|---|---|---|
| SEND | defaults.annotation | annotation-as-behavior | annotation-behavior-message | validate default and constraint semantics | Incorrectly gives a descriptive default annotation construction behavior. | none | none |
