> docai-messaging: 0.17.1 | profile: full | perspective: storefront | coverage: complete | knowledge: complete | source_refs: a
...
|---|---|---|---|---|---|---|
| a | configuration | none | none | none | a2.json | none |
