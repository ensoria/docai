...
|---|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order using a formatted workflow identifier | workflows/formatted.md | none | Serialization |
