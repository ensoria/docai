...
|---|---|---|---|---|---|---|---|
| SEND | constraints.unique | duplicate-exact-values | duplicate-message | validate default and constraint semantics | Contains mathematically equal array values despite uniqueItems. | none | none |
