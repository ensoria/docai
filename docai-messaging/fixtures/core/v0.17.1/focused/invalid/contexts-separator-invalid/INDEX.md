...
|---|---|---|---|---|---|---|---|
| SEND | orders.commands | create-order | create-order | create order | Creates an order command | workflows/a.md,workflows/b.md | none |

## Workflows

| Name | Summary | Details |
|---|---|---|
| A workflow | First order sequence | workflows/a.md |
| B workflow | Second order sequence | workflows/b.md |
