...
|---|---|---|---|---|---|---|---|
| SEND | behavior.commands | unqualified-exactly-once | unqualified-exactly-once | send exactly once | Omits the required guarantee scope and conditions | none | none |
