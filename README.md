...
DocAI HTTP `v1.0.0` is the current tagged public release and the first Stable contract, promoted from reviewed `v1.0.0-rc.4`, with its versioned conformance corpus at [`docai-http/fixtures/conformance/v1.0.0/`](docai-http/fixtures/conformance/v1.0.0/). This release does not broaden the comparison claims above.
