...
DocAI HTTP is preparing its first stable `1.0.0` boundary with a separate conformance corpus at [`docai-http/fixtures/conformance/v1.0.0/`](docai-http/fixtures/conformance/v1.0.0/). Stable publication still depends on the DocAI HTTP release process and should not broaden the comparison claims above.
