...
DocAI HTTP has published `v1.0.0-rc.1` with a separate `1.0.0` conformance corpus at [`docai-http/fixtures/conformance/v1.0.0/`](docai-http/fixtures/conformance/v1.0.0/). Final stable `v1.0.0` publication still depends on the DocAI HTTP release process and should not broaden the comparison claims above.
