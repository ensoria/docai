...
DocAI HTTP `1.0.0` is prepared as the first Stable release from the reviewed `v1.0.0-rc.4` contract, with its versioned conformance corpus at [`docai-http/fixtures/conformance/v1.0.0/`](docai-http/fixtures/conformance/v1.0.0/). The current tagged public release remains `v1.0.0-rc.4` until the final `v1.0.0` tag is published. This release work does not broaden the comparison claims above.
