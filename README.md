...
DocAI HTTP has published `v1.0.0-rc.4` with a separate `1.0.0` conformance corpus at [`docai-http/fixtures/conformance/v1.0.0/`](docai-http/fixtures/conformance/v1.0.0/). RC.4 corrects the focused-fixture metadata identity gap found in RC.3 review and is awaiting focused review before final stable `v1.0.0`. This release work does not broaden the comparison claims above.
