...
Do not commit API keys, bearer tokens, account IDs, provider raw logs, or authorization headers. Live result records under `docai-http/fixtures/complete-candidates/v0.11.0/evaluations/runs/` should contain only reviewed, publishable evaluation results and safe usage metadata.
