...
- Adds a polymorphism candidate fixture corpus and checker for tagged request body variants with complete examples and complete field tables per variant without promoting polymorphic body variants into the current Compatibility Core.
