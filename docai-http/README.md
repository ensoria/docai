...
> Specification version: 0.10.0 | status: Draft
...
- `0.10.0`(Draft) — Clarifies full/compact profile path pairing, same-kind `same_as` boundaries, structural identifier failure handling, always-null value representation, common-error suppression deviations, and inline errors with unknown codes.
...
```markdown
> docai-http: 0.10.0 | profile: full | coverage: complete | knowledge: complete | generated: 2026-06-30 | generation_id: full-20260630-abc123 | projection_id: 20260630-abc123 | source: openapi.yaml (OpenAPI 3.1.1) | source_revision: sha256:abc123
```
...
- [ ] Paths, methods, statuses, media types including the limited `**media_type**: unknown` form, structural boundaries, standard variable headings, table syntax and cell normalization, and inline error-shape labels follow §3.5; an operation whose endpoint method or path is absent or unrepresentable is not emitted as a compliant endpoint
