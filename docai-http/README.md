...
- `0.9.0`(Draft) — Tightens pre-1.0 version handling, convention-section selection, collapsed response-header boundaries, endpoint-specific common-error deviations, `same_as` retrieval metadata, token-routing metadata, and recursive-schema stabilization risk.
