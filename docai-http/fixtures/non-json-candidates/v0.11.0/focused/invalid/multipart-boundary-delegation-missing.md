...
Expected: invalid non-JSON candidate. Multipart documentation must delegate boundary construction to the HTTP library and tell callers not to hard-code the sample boundary.
