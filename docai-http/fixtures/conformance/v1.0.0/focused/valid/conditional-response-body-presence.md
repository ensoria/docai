...
Expected: valid complete conformance. Conditional response body presence states the exact caller-visible condition and keeps body omission separate from representation nullability.
