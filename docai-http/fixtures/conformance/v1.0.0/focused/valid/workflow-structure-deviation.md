...
Expected: valid complete conformance. A workflow title matches the INDEX workflow name, uses fixed sections in order, documents values passed, failure branches, recovery state, and places workflow-specific deviations correctly.
