...
Expected: valid complete conformance. A compact inline error shape uses `Client-visible fields` and `Opaque fields` after the example, preserving caller-visible error fields while reducing opaque detail.
