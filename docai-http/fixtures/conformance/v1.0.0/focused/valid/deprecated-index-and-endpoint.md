...
Expected: valid complete conformance. A deprecated endpoint has `**deprecated**:` immediately after the endpoint heading and `(deprecated)` at the start of the matching INDEX summary.
