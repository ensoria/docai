...
Expected: valid complete conformance. An `x-` heading appears after required response content, is exactly one level deeper than the response section, and ends before the next `###` heading.
