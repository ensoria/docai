...
Expected: valid complete conformance. Untagged alternatives use stable variant labels and selection prose; overlapping alternatives document combination semantics and include a combined variant.
