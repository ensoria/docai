...
Expected: valid complete conformance. A common error table maps rows to a common shape, and the shape contains body markers, a representation, a field table, and response headers.
