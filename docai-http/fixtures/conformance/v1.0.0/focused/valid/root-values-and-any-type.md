...
Expected: valid complete conformance. Root scalar, root array, and root dynamic-map bodies use `$`, while `any` is used only for an explicitly arbitrary decoded value.
