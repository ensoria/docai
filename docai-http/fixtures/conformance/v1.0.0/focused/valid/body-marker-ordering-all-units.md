...
Expected: valid complete conformance. Request bodies, responses, inline error shapes, common error shapes, and webhook payloads use their required marker order.
