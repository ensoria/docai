...
Expected: valid complete conformance. A grouped webhook uses payload variants when grouped events have different payload fields but share compatible delivery and receiver rules.
