...
Expected: valid complete conformance. Field-level errors identify the target field, machine-readable code, and whether the message can be shown in user-facing input UI.
