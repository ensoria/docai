...
Expected: valid complete conformance. Body-less requests and responses use explicit `none`, while unknown response body presence keeps the required body markers and unknown marker.
