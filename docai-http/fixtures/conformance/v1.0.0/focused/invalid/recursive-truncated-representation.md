...
Expected: invalid complete conformance. Recursive schemas are outside the intended 1.0 representable scope and must not be projected by truncating depth.
