...
Expected: invalid complete conformance. Unstructured streams such as SSE omit `body_nullable` and do not use a decoded field table; stream semantics are documented with sample and prose.
