...
Expected: invalid complete conformance. A polymorphic representation must not put an unlabeled representation-level example before the first `**variant**:` block.
