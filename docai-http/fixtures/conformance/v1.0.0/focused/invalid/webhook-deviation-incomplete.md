...
Expected: invalid complete conformance. A webhook delivery deviation must state the complete event-specific receiver contract needed by the client, not only that it differs from the default.
