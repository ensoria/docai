...
Expected: invalid complete conformance. The same concrete media type must not appear twice inside one response; same-media alternatives use variants or `unsupported`.
