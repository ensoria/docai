...
Expected: invalid complete conformance. Raw binary bodies omit `body_nullable` and do not use a decoded field table; they use a representative sample and prose.
