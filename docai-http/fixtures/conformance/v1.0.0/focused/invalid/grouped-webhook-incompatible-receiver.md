# invalid: grouped webhook incompatible receiver requirements

Expected: invalid complete conformance. A grouped webhook cannot merge events with event-specific receiver handling requirements.
...
- Only for subscription.cancelled, receiver handling may return 204.
````
