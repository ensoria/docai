...
Expected: invalid complete conformance. Field-level errors must identify the target field, machine-readable code, and UI-display policy when those facts are known.
