...
Expected: invalid complete conformance. A grouped webhook cannot merge events with different triggering endpoint references that cannot be represented as one shared related trigger.
