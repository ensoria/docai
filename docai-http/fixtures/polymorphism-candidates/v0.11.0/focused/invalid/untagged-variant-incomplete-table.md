...
Expected: invalid polymorphism candidate. Every untagged variant table must include the complete common and variant-specific fields for that alternative.
