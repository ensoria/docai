...
The required targets have been run against the OpenAPI baseline conditions, and the scoped comparison is summarized in `../../../../../OPENAPI-COMPARISON-EVIDENCE.md`. Future comparison work should add new APIs, task classes, or target models rather than treating this fixture-specific result as a general benchmark.
