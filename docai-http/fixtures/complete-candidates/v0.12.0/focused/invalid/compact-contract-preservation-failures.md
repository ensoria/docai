...
Expected: invalid complete candidate. Compact reductions must not omit request parameters, response statuses, error rows, or change client-visible constraints compared with the matching full profile.
