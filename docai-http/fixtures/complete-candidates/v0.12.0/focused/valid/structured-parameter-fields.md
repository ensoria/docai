...
Expected: valid complete candidate. A represented object query parameter has exact serialization, an encoded example, and complete structured-parameter fields.
