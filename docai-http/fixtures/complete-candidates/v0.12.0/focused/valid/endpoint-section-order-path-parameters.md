...
Expected: valid complete candidate. Endpoint sections appear in fixed order, path parameter rows exactly match path template variables, and later empty request sections retain their headings after the first non-empty subsection.
