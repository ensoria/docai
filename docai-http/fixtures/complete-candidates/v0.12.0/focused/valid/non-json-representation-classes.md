...
Expected: valid complete candidate. Complete-surface non-JSON focused coverage includes form-urlencoded, raw binary upload and download, CSV, XML, and SSE representation shapes beyond multipart.
