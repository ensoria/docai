...
**unsupported**: replaces workflow Steps: approval graph contains dynamic human-assigned branches at fixtures/complete-candidates/v0.12.0/source/complete-openapi.yaml#/x-docai-workflows/external-approval
