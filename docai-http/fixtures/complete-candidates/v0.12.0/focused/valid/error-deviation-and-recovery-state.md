...
Expected: valid complete candidate. Endpoint-specific common-error handling differences are marked with `**deviation**:`, and error-time state that affects recovery is stated in caller action.
