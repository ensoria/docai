...
**unsupported**: replaces response representation 200 application/json: directly recursive schema at fixtures/complete-candidates/v0.12.0/source/recursive-direct-openapi.yaml#/components/schemas/Node
````
