...
Expected: invalid complete candidate. A mixed error/non-error source default that cannot be split faithfully must not invent response or error body details; it must use the paired replacement markers.
