...
Expected: invalid complete candidate. A grouped webhook cannot merge events with event-specific delivery deviations that require different receiver contracts.
