...
Expected: invalid complete candidate. When no opaque root field exists, compact output omits the `Opaque fields` heading entirely instead of emitting an empty heading.
