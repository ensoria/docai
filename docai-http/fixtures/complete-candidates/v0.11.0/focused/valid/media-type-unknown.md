...
Expected: valid complete candidate. `**media_type**: unknown` is used only when a body representation exists but the concrete media type is absent from authoritative inputs.
