...
Expected: valid complete candidate. Multipart documentation states the media type, includes a realistic sample, documents file-part requirements, and tells callers to delegate boundary construction.
