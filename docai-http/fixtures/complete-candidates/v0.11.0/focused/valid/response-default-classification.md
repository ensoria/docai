...
**unsupported**: replaces Errors: error branch is inseparable from the mixed default response at fixtures/complete-candidates/v0.11.0/source/complete-openapi.yaml#/paths/~1imports~1{id}/get/responses/default
````
