...
Expected: valid complete candidate. A webhook is listed in INDEX, has a matching title, fixed sections, event-specific header wire rules, a complete delivery deviation, a safe deduplication key, and a triggering endpoint reference.
