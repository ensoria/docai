...
Expected: valid complete candidate. A compact response field table omits uniform `Presence` and `Nullable` columns, and readers reconstruct those logical columns before applying field-table rules.
