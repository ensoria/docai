...
Expected: valid complete candidate. A request body with multiple concrete representations repeats the representation markers and states how the caller selects the request media type.
