...
Expected: valid complete candidate. Deviations from CONVENTIONS.md are written inside the section they affect, including parameter, body, response, and webhook payload sections.
