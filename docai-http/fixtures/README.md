...
- `complete-candidates/v0.11.0/focused/valid/` and `complete-candidates/v0.11.0/focused/invalid/` contain initial focused complete-candidate snippets for profile pairing, selective conventions, compact `same_as`, compact opaque fields, and resource/workflow/webhook relations.
